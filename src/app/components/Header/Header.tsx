...
export default function Header({
  ...
  return (
    ...
    shadow-black/[0.1] backdrop-blur-[0.5rem] top-4 md:top-6 h-[2.75rem] md:h-[3.25rem] w-[80%] sm:w-[60%] lg:w-[50%] xl:w-[40%] rounded-full flex items-center justify-around z-10"
