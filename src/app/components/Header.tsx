    ...
    >
      <button
        className={`text-gray-900 ${
          isHomeInView ? 'text-opacity-100' : 'text-opacity-50'
        } hover:text-opacity-80 cursor-pointer transition text-black font-medium`}
        onClick={() =>
      ...
      <button
        className={`text-gray-900 ${
          isAboutInView ? 'text-opacity-100' : 'text-opacity-50'
        } hover:text-opacity-80 cursor-pointer transition text-black font-medium`}
        onClick={() =>
      ...
      <button
        className={`text-gray-900 ${
          isPortfolioInView ? 'text-opacity-100' : 'text-opacity-50'
        } hover:text-opacity-80 cursor-pointer transition text-black font-medium`}
        onClick={() =>
      ...
      <button
        className={`text-gray-900 ${
          isContactInView ? 'text-opacity-100' : 'text-opacity-50'
        } hover:text-opacity-80 cursor-pointer transition text-black font-medium`}
        onClick={() =>
