...
export default function About({
  ...
  return (
    <div
      className="h-screen w-full flex items-center justify-center gap-10 lg:gap-0 lg:justify-between flex-col lg:flex-row"
      ref={AboutRef}
    >
      <motion.div
      ...
      <div className="w-3/5 flex flex-col items-center justify-center gap-5 lg:gap-10">
        ...
        <div className="flex flex-col text-slate-300 gap-6 text-[12px] lg:text-base font-light text-center">
          <p className="lg:text-xl">
            ...
            Whether it&apos;s coding or crafting, attention to detail is my
            thing. I find joy in the process of creating something exceptional
            from scratch.
          </p>
          ...
          <p className="lg:text-xl">
            ...
            and staying healthy. I believe in taking on challenges and always
            looking for ways to
            <span className="text-white font-medium"> improve. </span>
            Whether it&apos;s hitting the gym or going for a run, staying fit is
            essential to me.
          </p>
          ...
          <p className="lg:text-xl">
            ...
            come first. I believe in doing what&apos;s right, even when no one
            is watching.
          </p>

          <p className="lg:text-xl">
            Interested in teaming up and creating something amazing together?
            Let&apos;s
